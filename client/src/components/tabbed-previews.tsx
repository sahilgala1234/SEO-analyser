      ...
      <CardContent className="p-6">
        ...
        <Tabs defaultValue="google" className="w-full">
          <TabsList className="grid w-full grid-cols-3 h-12 bg-gray-100 p-1">
            <TabsTrigger value="google" className="flex items-center space-x-2 h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">
            ...
            <TabsTrigger value="facebook" className="flex items-center space-x-2 h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">
              <svg className="h-4 w-4 text-blue-600" viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <span className="font-medium">Facebook</span>
            </TabsTrigger>
            <TabsTrigger value="twitter" className="flex items-center space-x-2 h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">
          ...
          <TabsContent value="google" className="mt-6">
            <div className="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-sm">
              <div className="flex items-center mb-4 text-sm text-gray-500">
                <span className="bg-gray-100 px-2 py-1 rounded text-xs font-medium">GOOGLE SEARCH RESULT</span>
              </div>
              <div className="space-y-2">
                <div className="text-sm text-green-700 font-mono break-all">
                  {displayUrl}
                </div>
                <div className="text-xl text-blue-600 hover:underline cursor-pointer font-medium leading-tight">
                  {displayTitle}
                </div>
          ...
          <TabsContent value="facebook" className="mt-6">
            <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden shadow-sm">
              <div className="flex items-center p-4 text-sm text-gray-500 bg-blue-50">
                <span className="bg-blue-100 px-2 py-1 rounded text-xs font-medium">FACEBOOK SHARE PREVIEW</span>
              </div>
              ...
              <div className={`aspect-video bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center border-b ${seoData.openGraph?.image ? 'hidden' : ''}`}>
          ...
          <TabsContent value="twitter" className="mt-6">
            <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden shadow-sm">
              <div className="flex items-center p-4 text-sm text-gray-500 bg-blue-50">
                <span className="bg-blue-100 px-2 py-1 rounded text-xs font-medium">TWITTER CARD PREVIEW</span>
              </div>
              ...
              <div className={`aspect-video bg-gradient-to-br from-blue-400 to-cyan-500 flex items-center justify-center border-b ${seoData.twitterCard?.image ? 'hidden' : ''}`}>
                <Image className="text-white text-3xl opacity-75 h-12 w-12" />
              </div>
              <div className="p-5">
                <div className="font-bold text-gray-900 mb-2 text-lg leading-tight">
                ...
                <div className="text-xs text-gray-500 flex items-center">
                  ...
                  <span>{getDomain(displayUrl).toLowerCase()}</span>
                </div>
              </div>
            </div>
          </TabsContent>
